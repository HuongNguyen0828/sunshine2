...
import { fetchSchedulesForParent, processAndSplitSchedules, fetchingPublicHolidayAlberta } from "@/services/useScheduleAPI";
...
export default function ParentCalendar() {
  ...
  const fetchSchedulesData = async () => {
    ...
    try {
      const results = await fetchSchedulesForParent(currentMonthString);
  ...
  const childrenBirthdayEachMonth = useMemo(() => childrenContext.reduce((acc, child) => {
    ...
    const event: Event = {
      ...
      classes: [classesContext.filter((clsId: string) => clsId === child.classId)[0]],
      date: child.birthday,
      children: [child.name],
    ...
    if (whichMonth === currentMonth.getMonth()) {
      ...
      console.log("Month birthday", whichMonth)
